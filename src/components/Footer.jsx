    ...
    <div className='pt-10 px-4 md:px-20 lg:px-32 bg-gray-900 w-full overflow-hidden' id='footer'>
      <div className='container mx-auto flex flex-col md:flex-row justify-between items-center text-white'>
        <div className='w-full md:w-1/3 mb-8 md:mb-0'>
            ...
            <p>Find your dream home effortlessly.</p>
        </div>
        <div className='w-full md:w-1/3 mb-8 md:mb-0'>
      ...
      <div className='border-t border-gray-700 text-center text-gray-400 py-4 mt-8'>
       Copyright 2025 @DikshaSehrawat | All rights reserved
      </div>
    </div>
  )
}
